...
| Start here | Purpose |
|-----------|---------|
| [Technical Dossier (PDF)](https://github.com/rookepoole/SVP-OTG-Poole-Manifold-tests/blob/main/Technical%20Dossier_%20Poole%20Manifold.pdf) | Complete technical description, constants, and predictions |
| [Experiments/](https://github.com/rookepoole/SVP-OTG-Poole-Manifold-tests/tree/main/Experiments) | All experiment folders |
